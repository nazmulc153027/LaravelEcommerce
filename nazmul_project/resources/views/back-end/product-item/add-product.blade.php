	...
	<div class="container">
		<div class="row ">
			<div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10 mx-auto mt-5 bg-dark text-white p-3">
             ...
             {{Form::open(['url' => 'product-info', 'Method'=>'POST', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data'])}}
             ...
             <div class="form-group">
             	...
             	<div class="col-sm-10">
             		<input type="text" class="form-control" name="product_name" aria-describedby="emailHelp" placeholder="your product name">
              ...
              <div class="form-group">
             	...
             	<div class="col-sm-10">
             		<input type="number" class="form-control" name="product_price" aria-describedby="emailHelp" placeholder="your product price">
            ...
            <div class="form-group">
             	...
             	<div class="col-sm-10">
             		<input type="text" class="form-control" name="product_quantity" aria-describedby="emailHelp" placeholder="your product quantity">
             ...
             <div class="form-group">
             	...
             	<div class="col-sm-10">
             		<input type="text" class="form-control" name="short_description" aria-describedby="emailHelp" placeholder="your short description">
             ...
             <div class="form-group">
             	...
             	<div class="col-sm-10">
             		<input type="text" id="mytextarea" class="form-control"  name="long_description"  placeholder="your long description">
             ...
             <div class="form-check">
                     ...
                     <button type="submit" class="btn btn-warning mb-5 float-right w-25">Save Product Information</button>
