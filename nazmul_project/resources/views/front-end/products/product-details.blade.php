							...
							<h4>{{$product->product_name}}</h4>
							  <div class="block">
								<div class="starbox small ghosting"> </div>
									...
									<p class="price item_price">TK:{{$product->product_price}}
                                     <span class="text-danger">{{$errors->has('product_price') ? $errors->first('product_price') : ''}}</span>
									</p>
									<div class="description">
										<p>{{$product->short_description}}</p>
									</div>
							           {{Form::open(['url'=> 'addto-cart','method'=>'POST'])}}
										...
										<h6>Quality :</h6>
											<div class="quantity"> 
												<input type="number" name="quantity" value="1" min="1">
												 ...
												 <input type="hidden" value="{{$product->id}}" name="product_id" aria-describedby="emailHelp">
											</div>
												<!--quantity
														<script>
									...
									<div class="women">
										...
										<input type="submit" name="btn" value="Add to cart" class="my-cart">
									</div>
									{{Form::close()}}
